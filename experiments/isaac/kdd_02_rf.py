...
print(f"Modelo: Random Forest (Balanced)")
...
print("Notas: ColumnTransformer, RF(n_estimators=100, max_depth=15, class_weight=balanced)")
...
pd.DataFrame({
    ...
    'prediction': y_pred
}).to_csv("02_RESULTS/KDD/isaac/validation_predictions_rf.csv", index=False)
